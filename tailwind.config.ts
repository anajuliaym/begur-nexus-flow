  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-scale": { "0%, 100%": { transform: "scale(1)" }, "50%": { transform: "scale(1.02)" } },
        "glow-pulse": { "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--primary) / 0.4)" }, "50%": { boxShadow: "0 0 20px 4px hsl(var(--primary) / 0.2)" } },
      },
      animation: {
