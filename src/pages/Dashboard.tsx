  ...
  return (
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-6 gap-4">
        ...
        <Kpi label="Em execução" value={stageCounts("execucao")} tone="primary" icon={AlertTriangle} />
      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-8 space-y-4">
          ...
          {(["solicitacao", "crossdocking", "preparacao", "execucao"] as DeliveryStage[]).map(stage => {
