...
export default function PortalCliente() {
  ...
  return (
    <div className="p-5 space-y-5">
      ...
      {/* Identidade cliente */}
      <div className="panel p-4 flex items-center gap-4 bg-gradient-glow">
        <div className="h-12 w-12 rounded-md bg-surface-2 grid place-items-center">
        ...
        <div className="flex gap-6">
          <div className="text-center"><div className="text-xl font-bold tnum">412</div><div className="text-[10px] text-muted-foreground">pedidos 30d</div></div>
          <div className="text-center"><div className="text-xl font-bold tnum text-success">98,1%</div><div className="text-[10px] text-muted-foreground">OTIF</div></div>
          <div className="text-center"><div className="text-xl font-bold tnum text-warning">3</div><div className="text-[10px] text-muted-foreground">aprovações</div></div>
        </div>
      </div>

      <div className="grid grid-cols-12 gap-5">
        {/* Nova solicitação */}
        <div className="panel col-span-12 lg:col-span-5 p-4">
          ...
          <div className="space-y-2.5">
            <div>
              ...
              <select className="w-full mt-1 bg-surface-2 border border-border rounded px-2 py-1.5 text-sm">
            ...
            <div>
              ...
              <input className="w-full mt-1 bg-surface-2 border border-border rounded px-2 py-1.5 text-sm" defaultValue="Chopeira Heineken Sub 30L · 14 un" />
            </div>
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="text-[10px] uppercase tracking-wider text-muted-foreground">Origem</label>
                <input className="w-full mt-1 bg-surface-2 border border-border rounded px-2 py-1.5 text-sm" defaultValue="CD Heineken — Jacareí/SP" />
              </div>
              <div>
                <label className="text-[10px] uppercase tracking-wider text-muted-foreground">Janela</label>
                <input className="w-full mt-1 bg-surface-2 border border-border rounded px-2 py-1.5 text-sm" defaultValue="06h–10h" />
              </div>
            </div>
            <div>
              <label className="text-[10px] uppercase tracking-wider text-muted-foreground">Anexos</label>
              <div className="mt-1 border border-dashed border-border rounded p-3 text-center text-[11px] text-muted-foreground">
            ...
            {[
              ...
              <div key={i} className="p-3 row-hover">
                <div className="flex items-center gap-2 mb-1">
                  <span className="chip bg-warning/10 text-warning border-warning/30 text-[10px]">{a.type}</span>
