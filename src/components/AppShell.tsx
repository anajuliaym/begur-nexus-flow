...
const NAV = [
  { to: "/", label: "Control Tower", icon: LayoutDashboard, badge: "live" },
  { to: "/requests", label: "Requests", icon: Inbox, badge: 7 },
  { to: "/orders", label: "Orders", icon: PackageSearch, badge: 1284 },
  ...
  { to: "/occurrences", label: "Occurrences", icon: AlertTriangle, badge: 23, tone: "destructive" },
      ...
      <aside className="w-[244px] shrink-0 border-r border-sidebar-border bg-sidebar flex flex-col">
        <div className="h-14 px-4 flex items-center gap-2.5 border-b border-sidebar-border">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[10px] uppercase tracking-[0.14em] text-muted-foreground">Control Tower</span>
          </div>
        </div>

        <div className="px-3 pt-3 pb-2">
          <div className="text-[10px] uppercase tracking-wider text-muted-foreground/70 px-2 mb-1.5">Operations</div>
                ...
                >
                  ...
                  {item.badge !== undefined && (
                    <span className={cn(
                      ...
                      {item.badge === "live" ? "● LIVE" : item.badge.toLocaleString()}
                    </span>
                  )}
                </NavLink>
              );
        ...
        <div className="mt-auto p-3 border-t border-sidebar-border space-y-2">
          ...
          <div className="flex items-center gap-2 px-2 py-1.5 rounded-md hover:bg-sidebar-accent">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-muted-foreground truncate">Operations Manager</div>
            </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-14 border-b border-border bg-card/60 backdrop-blur flex items-center px-5 gap-4">
          ...
          <div className="flex-1 max-w-md mx-auto relative">
            ...
            <input
              placeholder="Search orders, drivers, trips, clients…"
          ...
          <div className="flex items-center gap-2">
            <div className="hidden md:flex items-center gap-2 px-2.5 py-1 rounded-md bg-success/10 border border-success/30">
              ...
              <span className="text-[11px] font-semibold text-success uppercase tracking-wider">All systems operational</span>
            </div>
